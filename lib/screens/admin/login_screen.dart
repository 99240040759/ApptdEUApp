        ...
        body: Center(child: Padding(
          ...
          child: Card(child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const Text('Access Denied', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: AppColors.primary)),
              const SizedBox(height: 8),
              Text('${_user!.email} does not have admin privileges.',
                style: const TextStyle(color: AppColors.textMuted), textAlign: TextAlign.center),
              const SizedBox(height: 8),
              SelectableText('UID: ${_user!.uid}',
                style: const TextStyle(fontSize: 11, color: AppColors.textMuted)),
              const SizedBox(height: 8),
              const Text('To grant access, add a Firestore document at users/{your-uid} with field role: "admin"',
